        ...
        <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <p className="text-sm mt-3 text-gray-500">PrebuiltUI strikes the perfect balance between flexibility, simplicity and visual consistency.</p>
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <p className="text-sm mt-3 text-gray-500">Clean layouts, responsive design and easy integration make PrebuiltUI incredibly valuable.</p>
                    <div className="flex items-center gap-3 mt-4">
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <p className="text-sm mt-3 text-gray-500">This library helped me ship client projects faster with better and beautiful design experience.</p>
                    <div className="flex items-center gap-3 mt-4">
