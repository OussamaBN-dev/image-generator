  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        ...
        <p className='text-gray-500 mx-auto max-w-lg'>Everything you need 
            create, enhance, and optimize your content with cutting-edge AI
            technologie.
        </p>
      </div>
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {AiToolsData.map((tool, index) => (
            ...
            shadow-lg border border-gray-100 hover:-translate-y-1 transition
            duration-300 cursor-pointer' onClick={() => navigate(tool.path)}>
